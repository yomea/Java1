...
$(document).ready(function(){
	var a = new Pop({ oPop: "idPop_a", zIndex: 1001, mode: ["center", "center"], idOpen: "open_a", idClose: ["close_a", "close_a_1"], cover: true, beCover: false, zIndexCover: 1000, colorCover: "#000", opactiyCover: 0.5 });
	var b = new Pop({ oPop: "idPop_b", zIndex: 1001, mode: ["center", "center"], idOpen: "open_b", idClose: ["close_b", "close_b_1"], cover: true, beCover: false, zIndexCover: 1000, colorCover: "#000", opactiyCover: 0.5 });
	var c = new Pop({ oPop: "idPop_c", zIndex: 1001, mode: ["center", "center"], idOpen: "open_c", idClose: ["close_c", "close_c_1"], cover: true, beCover: false, zIndexCover: 1000, colorCover: "#000", opactiyCover: 0.5 });
	var d = new Pop({ oPop: "idPop_d", zIndex: 1001, mode: ["center", "center"], idOpen: "open_d", idClose: ["close_d", "close_d_1"], cover: true, beCover: false, zIndexCover: 1000, colorCover: "#000", opactiyCover: 0.5 });
    var e = new Pop({ oPop: "idPop_e", zIndex: 1001, mode: ["center", "center"], idOpen: "open_e", idClose: ["close_e", "close_e_1"], cover: true, beCover: false, zIndexCover: 1000, colorCover: "#000", opactiyCover: 0.5 });
	var f = new Pop({ oPop: "idPop_f", zIndex: 1001, mode: ["center", "center"], idOpen: "open_f", idClose: ["close_f", "close_f_1"], cover: true, beCover: false, zIndexCover: 1000, colorCover: "#000", opactiyCover: 0.5 });
	var g = new Pop({ oPop: "idPop_g", zIndex: 1001, mode: ["center", "center"], idOpen: "open_g", idClose: ["close_g", "close_g_1"], cover: true, beCover: false, zIndexCover: 1000, colorCover: "#000", opactiyCover: 0.5 });
    var h = new Pop({ oPop: "idPop_h", zIndex: 1001, mode: ["center", "center"], idOpen: "open_h", idClose: ["close_h", "close_h_1"], cover: true, beCover: false, zIndexCover: 1000, colorCover: "#000", opactiyCover: 0.5 });
});