    		...
    		if(request.readyState === 4) {
    			if(request.status === 200) {
    				var context = request.responseText;
    				 //alert(context);
    				 eval(context);//服务器端动态生成javascript代码。
                    ...
                    <tr>
                      ...
                      <form name="search" action="" method="post" style="position:absolute; left:650px; top:125px;">
	                        ...
	                        <select name="b" style="font-size: 9pt; color: rgb(85, 85, 85);">
	                        	<option selected="selected" value="0" >-所有子商品-</option>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              %>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="left" height="25" width="73%">会员号：<%=user.getUsername() %>
                                        </td>
                                        <td><a href="modify.jsp">修改信息</a></td>
                                        </tr>
                                        <tr>
                                        <td><a href="buydetail.jsp">我的购物车</a></td>
                                        <td><a href="unlogin.jsp">注销</a></td>
                                      </tr>
                                  </tbody>
                                    ...
                                    <tr>
									  ...
									  <div style="display:inline-block; margin-left:20px;">
										 <a href="productdetail.jsp?id=<%=p.getId() %>"><img alt="product" src="shoppingfiles/2016032516441214.jpg" width="90" height="90" /><br>
										  ...
										  <span style="text-decoration:line-through;">市场价：<%=p.getNormalPrice() %></span>	<br>
										   <span>会员价：<%=p.getMemberPrice() %></span>	</a>						  
									  </div>
									  <%} %>
