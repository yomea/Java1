  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr valign="top">
        ...
        <div>
		<form name="oneForm" method="get" action="reply.jsp" onsubmit="return check()">
			<input type="hidden" name="action" value="true" />
			<input type="hidden" name="id" value="<%=reId %>" />
			<input type="hidden" name="rootid" value="<%=reRootId %>" />
			<input type="text" name="title" placeholder="请输入标题。。。"  size="80" /><br />
			<textarea name="cont" rows="10" cols="80" placeholder="请输入内容。。。"></textarea><br />
